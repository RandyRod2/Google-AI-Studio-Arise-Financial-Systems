...
const Quoter: React.FC = () => {
    ...
    }, [inputs, selectedConditions, carrierPlans]);
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shrink-0">
                <div>
                    <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                        <Calculator className="text-indigo-500" /> Smart Quoter
                    </h2>
                    <p className="text-slate-400 text-sm">Underwriting intelligence engine. Real-time approval odds.</p>
                </div>
            </div>
                ...
                <div className="w-full lg:w-96 flex flex-col gap-6 overflow-y-auto pr-1">
                    ...
                    <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        <select 
                                            className="w-full p-2 pr-8 border border-slate-700 rounded-lg text-sm bg-slate-950 text-white focus:ring-2 focus:ring-indigo-500 outline-none appearance-none"
                                            value={inputs.state}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="flex bg-slate-950 p-1 rounded-lg border border-slate-800">
                                        <button 
                                            className={`flex-1 py-1 text-xs rounded font-medium transition-all ${inputs.gender === 'Male' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
                                            onClick={() => setInputs({...inputs, gender: 'Male'})}
                                        >
                                            M
                                        </button>
                                        <button 
                                            className={`flex-1 py-1 text-xs rounded font-medium transition-all ${inputs.gender === 'Female' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-slate-400 mb-1">Nicotine</label>
                                    <div className="flex bg-slate-950 p-1 rounded-lg border border-slate-800">
                                        <button 
                                            className={`flex-1 py-1 text-xs rounded font-medium transition-all ${inputs.tobacco === 'Yes' ? 'bg-red-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
                                            onClick={() => setInputs({...inputs, tobacco: 'Yes'})}
                                        >
                                            Yes
                                        </button>
                                        <button 
                                            className={`flex-1 py-1 text-xs rounded font-medium transition-all ${inputs.tobacco === 'No' ? 'bg-green-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-300'}`}
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-400 mb-1">Face Amount</label>
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</span>
                                    <input 
                                        type="number" 
                                        step="1000"
                                        className={`${numInputClass} pl-7 font-bold text-white`}
                    ...
                    {/* Medical Logic Card */}
                    <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 shadow-sm flex-1">
                        <h3 className="font-bold text-white mb-4 flex items-center gap-2 text-sm uppercase tracking-wide">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input 
                                ...
                                className="w-full pl-9 pr-4 py-2 border border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 outline-none bg-slate-950 text-white placeholder-slate-600"
