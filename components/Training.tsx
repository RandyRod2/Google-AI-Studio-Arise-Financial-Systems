        ...
        <div className="animate-fade-in space-y-6 h-full flex flex-col">
            ...
            {activeTab === 'MODULES' && (
                <div className="space-y-6 flex-1 overflow-y-auto">
                    {/* Progress Bar */}
                    <div className="flex items-center gap-4 bg-slate-900 p-3 rounded-xl border border-slate-800 shadow-sm w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {courses.map((course) => (
                            <div 
                                ...
                                className="bg-slate-900 rounded-xl border border-slate-800 shadow-sm overflow-hidden hover:shadow-lg hover:border-indigo-500/30 transition-all group cursor-pointer relative top-0 hover:-top-1"
                            >
                                <div className="h-36 bg-slate-950 relative flex items-center justify-center overflow-hidden">
                                ...
                                <div className="p-5">
                                    ...
                                    <h3 className="font-bold text-white mt-1 mb-2 line-clamp-2 h-10 text-sm leading-relaxed">{course.title}</h3>
                    ...
                    {/* Certifications */}
                    <div className="mt-8 bg-indigo-900/10 rounded-2xl p-6 border border-indigo-500/20">
                        <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                            <Award className="text-yellow-500" /> Your Certifications
                        </h3>
                        <div className="flex flex-wrap gap-4">
                            <div className="flex items-center gap-3 p-4 bg-slate-900 border border-slate-800 rounded-xl shadow-sm min-w-[240px]">
                                <div className="w-10 h-10 bg-yellow-500/20 text-yellow-500 rounded-full flex items-center justify-center text-xl shadow-inner border border-yellow-500/20">🏆</div>
                                <div>
                                    <p className="font-bold text-white text-sm">Top Producer 2023</p>
                                    <p className="text-xs text-slate-500">Issued Jan 2024</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 p-4 bg-slate-900 border border-slate-800 rounded-xl shadow-sm min-w-[240px]">
                                <div className="w-10 h-10 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center text-xl shadow-inner border border-blue-500/20">🎓</div>
                                <div>
                                    <p className="font-bold text-white text-sm">IUL Master Class</p>
                                    <p className="text-xs text-slate-500">Issued Mar 2024</p>
                                </div>
                            </div>
                            {completedCourses === totalCourses && totalCourses > 0 && (
                                <div className="flex items-center gap-3 p-4 bg-slate-900 border border-green-500/30 rounded-xl shadow-sm min-w-[240px] animate-fade-in">
                                    <div className="w-10 h-10 bg-green-500/20 text-green-400 rounded-full flex items-center justify-center text-xl shadow-inner border border-green-500/20">🌟</div>
                                    <div>
                                        <p className="font-bold text-white text-sm">Agency All-Star</p>
